...
<div>
	...
	<?php
	/*************************************************/
	$nextPage = get_site_url();
	if(trim($_SERVER["REQUEST_URI"]) == '/beta/cart/') {
		$nextPage = '/beta/checkout/';
	}
	if(trim($_SERVER["REQUEST_URI"]) == '/beta/checkout/') {
		$nextPage = '/beta/checkout/';
	}
	if(trim($_SERVER["REQUEST_URI"]) == '/beta/checkout/') {
	...
	<a href="<?php echo $nextPage;?>" id="nextpage">NEXT</a>
</div>
</div>
	<p id="notyet">Not yet to check out yet?</p>
	<a class="continue_shopping" href="<?php echo get_site_url().'/collections/';?>">Colntinue shopping</a>
</div>
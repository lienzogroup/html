...
<table class="shop_table order_details checkout_order_details">
	<thead>
		<tr>
...
<?php endif; ?>
		...
		<address><p>
			<?php
				if (!$order->get_formatted_shipping_address()) _e('N/A', 'woocommerce'); else echo $order->get_formatted_billing_address();
			?>
		</p></address>

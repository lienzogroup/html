...
class MR_Social_Sharing_Toolkit {
	...
	function create_bookmarks($url = '', $title = '', $type = '', $media = '', $description = '') {
		...
		$bookmarks = '
				...
				<h2 class="share-the-collection">share with friends</h2>
				
				<div class="social-share-line">
				
				<span class="mr_social_sharing_top arrow">
				<img src="../../wp-content/themes/revelryhouse/img/drop-arrow-down.png">
				</span>	
		...
		$bookmarks .= '</div></div> ';
		$bookmarks = str_replace('<div class="mr_social_sharing_wrapper"></div></div>', '', $bookmarks);
		$this->count++;
		return $bookmarks;	
	}
...
background: url(../../wp-content/themes/revelryhouse/img/share-line.png) no-repeat center center;
}
*/
?>
...
<script>
	jQuery("#user_container #content #sliderContainer #orders .order td a").click(function(){
	
		/* GET HREF VALUE */
		var href = jQuery(this).attr("href");
		var myClass = jQuery(this).attr("class");
		var myValue = jQuery(this).html();
		
		var mainContainer = "#user_container #content #sliderContainer";
		var mainContainerData = "#user_container #content #sliderContainer #orders_details";
		var containerPos = -3840;
		
		if(myClass == 'button pay') {
			window.location = href;
		}
		else if(myClass == 'button') {

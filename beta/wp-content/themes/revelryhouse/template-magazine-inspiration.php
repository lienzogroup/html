...
/**
 *
 * Template Name: Magazine Inspiration Page
 * Description: Page template to display the custom Magazine Inspirations.
 *
 */
...
if ($pages) 
{
	echo '<ul class="magazine-article-type"><li><a href="'. $magazinePermalink .'">inspirations</a></li>';
	echo $pages; 
	echo '</ul>';
} 
?>

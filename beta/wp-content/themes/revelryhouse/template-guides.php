 ...
 * Description: Page template to display the custom Guides.
 *
 */
...
<section class="middle" style="margin: 185px auto 0;text-align: center;width: 960px;">
...
<?php 
				$args = array('post_type' => 'guides', 'posts_per_page' => 3, 'category_name' => 'collection-new');
...
<?php 
				$args = array('post_type' => 'guides', 'posts_per_page' => 3, 'category_name' => 'collection-pre-order');
      			$loop = new WP_Query($args);
      			while ($loop->have_posts()) : $loop->the_post(); ?>
...
<?php 
				$args = array('post_type' => 'guides', 'posts_per_page' => 6, 'category__not_in' => array( 23, 26 ));
      			$loop = new WP_Query($args);
      			while ($loop->have_posts()) : $loop->the_post(); ?>

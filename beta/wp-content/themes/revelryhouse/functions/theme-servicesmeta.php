...
$meta_box_service = array(
		'id' => 'services_details',
        'title' => __('Service Details', 'reboot'),
        'page' => 'services',
        'context' => 'normal',
        'priority' => 'high',
        'fields' => array(
            array(
                'name' => __('Service URL', 'reboot'),
                'desc' => __('Insert a url for your service to link to. (ie; http://www.mysite.com/service-name/', 'reboot'),
...
function gt_save_data_service($post_id) {
    ...
    if (!wp_verify_nonce($_POST['gt_add_box_service_nonce'], basename(__FILE__))) {
        return $post_id;
    }

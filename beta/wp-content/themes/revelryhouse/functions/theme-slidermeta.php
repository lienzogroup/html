...
$meta_box_slider = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => __('Slide URL', 'reboot'),
                'desc' => __('Insert a url for the slide to link to.', 'reboot'),
                'id' => $prefix . 'slide_url',
                'type' => 'text'
            )
    )
...
function gt_save_data_slider($post_id) {
    ...
    if (!wp_verify_nonce($_POST['gt_add_box_slider_nonce'], basename(__FILE__))) {
        return $post_id;
    }

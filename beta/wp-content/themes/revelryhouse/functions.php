...
require_once( get_template_directory() . '/woocommerce/functons.php' );
...
add_image_size( 'related', 340, 380, true ); // Small thumbnails
...
function custom_gallery($attr) {
	...
	$output .= "
			...
			<a class='carousel-control carousel-control-prev left' href='#$selector' data-slide='prev'></a>

  			<a class='carousel-control carousel-control-next right' href='#$selector' data-slide='next'></a>
...
global $menu;
	...
	$restricted = array(__('Slides'), __('Services'), __('Portfolio'), __('Links'));
